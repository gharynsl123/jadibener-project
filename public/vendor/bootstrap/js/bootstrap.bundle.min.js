...
(function($) {
    ...
    // Fungsi untuk memeriksa ukuran layar dan menentukan apakah sidebar harus ditutup atau dibuka saat di-scroll
    function checkScreenSize() {
      if ($(window).width() <= 800) {
        // Jika layar adalah ukuran hp, maka biarkan sidebar terbuka saat di-scroll
        $("body").addClass("sidebar-toggled");
        $(".sidebar").addClass("toggled");
      } else {
        // Jika layar lebih besar dari ukuran hp, maka atur kembali tampilan sidebar sesuai kebutuhan Anda
        // Misalnya, jika Anda ingin menutup sidebar saat di-scroll, Anda dapat menghapus kode ini
        // $("body").removeClass("sidebar-toggled");
        // $(".sidebar").removeClass("toggled");
      }
    }
  
    // Panggil fungsi checkScreenSize saat halaman dimuat dan saat ukuran layar berubah
    ...
    // Sisipkan kode lain Anda di sini
  
    $("#sidebarToggle, #sidebarToggleTop").on("click", function(e) {
      $("body").toggleClass("sidebar-toggled");
      $(".sidebar").toggleClass("toggled");
      // Anda dapat menambahkan kode tambahan di sini sesuai kebutuhan
    });
