...
(function (c) {
    ...
    c.extend(!0, f.defaults, {
        ...
        renderer: "bootstrap",
        searching: true, // Aktifkan fitur pencarian (search)
        info: true, // Tampilkan informasi jumlah entri (showing entries)
        paging: true, // Aktifkan fitur pagination
        lengthMenu: [[5, 10, 25, 50, -1], [5, 10, 25, 50, "All"]],
        pageLength: 5,
        ordering: false, // Sembunyikan fitur pengurutan (sorting)
        order: [[0, 'desc']] // Mengurutkan data berdasarkan kolom pertama (indeks 0) secara descending
    });    
